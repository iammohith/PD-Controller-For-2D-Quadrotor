...
$$
\begin{bmatrix} \ddot{y} \\ \ddot{z} \\ \ddot{\phi} \end{bmatrix} = \begin{bmatrix} 0 \\ -g \\ 0 \end{bmatrix} + \frac{1}{m} \begin{bmatrix} -\sin(\phi) & 0 \\ \cos(\phi) & 0 \\ 0 & \frac{m}{I_{xx}} \end{bmatrix} \begin{bmatrix} u_1 \\ u_2 \end{bmatrix} \quad (3)
$$
